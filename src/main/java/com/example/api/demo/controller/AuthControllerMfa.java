...
import com.example.api.demo.entity.LoginRequest;
import com.example.api.demo.entity.MfaVerificationResponse;
import com.example.api.demo.entity.UserMfa;
import com.example.api.demo.service.JWTService;
import com.example.api.demo.service.UserService;
import com.example.api.demo.entity.MfaVerificationRequest;
...
@CrossOrigin
@RestController
public class AuthControllerMfa {
     ...
     */
    public AuthControllerMfa(UserService userService, JWTService jwtService, AuthenticationProvider authenticationProvider) {
    ...
    public ResponseEntity<?> register(@Validated @RequestBody UserMfa user) {
    ...
    public ResponseEntity<?> login(@Validated @RequestBody LoginRequest loginRequest) {
        ...
        try {//Get the user and Compare the password
            ...
            UserMfa user = (UserMfa) authentication.getPrincipal();
